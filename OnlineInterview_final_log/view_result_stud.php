...
if(!isset($_GET['selected_stud']))
{
	header('location: view_result.php');	
}
else
{	
	$userid= $_GET['selected_stud'];
}
...
<script type="text/javascript">
    ...
    <div class="login_box" id="login_box">
    	...
    	<mmm class="box_header" id="box_header">
			Result showing for Roll no. : <?php echo $userid;?> 
        </mmm>
	...
	while($row = mysql_fetch_array($res))
	{
		...
		?>
			...
			<tr>          
            <?php
            	$link="review_admin.php?selected_stud=".$userid."&id=".$prid."&test_id=".$testid."&tname=".$testname."&tduration=".$testduration."&tno=".$testtotalqstn;
			?>
...
{ ?>
	<div style=" text-align:center;width:300px; height:150px; position:absolute; 
    left:50%; top:50%; margin-left:-150px; margin-top:-75px; border:2px dashed #039;">
    	<br /><br /><br />Either the Student is not Registered or Have not given any Exams !!
    </div>	
  <?php
}
?>
