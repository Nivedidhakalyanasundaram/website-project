...
<body>
   ...
   <div class="actions">
    ...
    <div class="login_box" id="login_box">
    	<p class="box_header" id="box_header">Select Your Course</p>
        ...
        <div class="xam_panel" id="xam_panel">
				...
				<div >
    		<!-- <a href="myrestaurant.php" class="list-group-item active">My</a>-->

    		<a href="android.php" class="list-group-item ">Android</a>
    		<a href="phpcourse.php" class="list-group-item ">PHP</a>  
			<a href="javacourse.php" class="list-group-item ">JAVA</a>
			<a href="aspcourse.php" class="list-group-item ">ASP.NET</a>
			<a href="sqlcourse.php" class="list-group-item ">SQL</a>
