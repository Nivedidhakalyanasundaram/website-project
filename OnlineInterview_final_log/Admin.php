...
<script type="text/javascript">
	...
	function logmein()
	{
		...
		var dataString='username='+usrname+'&password='+pwd;
...
<body>
	<header><txt style=" font-size:24px;">Online Interview</txt></header>
        <div style="position:absolute; top:3px; left:3px;">
    	
    </div>
    <div class="login_box" id="login_box">
    	<p class="login_hdr">Login</p>
        ...
        <form class="login_form" id="login_form">
            ...
            <br />
            <input type="button" value="Login" class="Button" onclick="logmein();" id="btn_login" name="btn_login" />
            <br />
	...
	<footer><h5>Online Interview 2018| All Rights Reserved</h5></footer>
</body>
</html>