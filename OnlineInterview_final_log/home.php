...
<body>
	<header><txt style=" font-size:24px;">Online Tutorial</txt></header>
        ...
        <div  style="position:absolute; width:50px; height:50px; right:320px; top:4px; " >
        		...
        		<a title="home" id="TakeAction" class="gohome" href="study.php" ></li>
        			<ul class="header_icon">
        		
					<li>
        			<img src="image/home.png" width="43" height="auto"   />
        		</li>
        		<li><h2 class="header_courses">Courses</h2></li>
        		<li><img src="image/user.png" width="30px" height="auto" style="    padding: 10px 0px 0px 20px;" /></li>
				<li><mno style="float:left; margin-top:4px;"><?php echo $_SESSION['User_name'];?></mno></li>
        	</ul>
